...
# Set default rank for single-process execution.
# This prevents "rank_zero_only.rank needs to be set before use" errors.
# For multi-GPU scenarios, this can be overridden by the training framework.
